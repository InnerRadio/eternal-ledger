...
from backend.app.cms.canonicalization import router as canonicalization_router
from backend.app.fcis.routes import router as fcis_router
...
app.include_router(fcis_router)
...
app.mount("/dashboard", StaticFiles(directory="/var/www/eternal-ledger-github/frontend/dashboard", html=True), name="dashboard")
