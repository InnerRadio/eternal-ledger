...
def public_network_pulse(
    ...
    for platform_user in users:
        ...
        active_orgs = memberships_by_user_id.get(
            platform_user.id,
            [],
        )
    ...
    for organization in organizations:
        ...
        partner_score = (
            ...
            + len(org_clicks)
            + (
                len(creator_relationships)
                * 20
            )
            + (
                len(rescue_relationships)
                * 20
            )
            + int(
    ...
    leaderboard_highlights = {
        ...
        "privacy":
            "Public-safe highlights exclude email, user_id, referral_code, and internal organization_id.",
    }
    ...
    return {
        "module":
            "PurPaws Network Pulse",

        "status":
            "active",

        "version":
            "v30b-public-network-pulse",

        "visibility":
            "public",

        "network":
            "PurPaws Continuity Network",

        "philosophy":
            "The Pulse Medallion is the public-facing heartbeat of the community.",

        "metrics": {
            "published_memorials":
                pulse_counts["activity"]["memorials"],

            "published_media_assets":
                pulse_counts["activity"]["media_assets"],

            "published_contributions":
                pulse_counts["activity"]["contributions"],

            "members":
                pulse_counts["network"]["members"],

            "organizations":
                pulse_counts["network"]["organizations"],

            "creators":
                pulse_counts["network"]["creators"],

            "rescues":
                pulse_counts["network"]["rescues"],

            "rescue_organizations":
                pulse_counts["network"]["rescue_organizations"],

            "affiliates":
                pulse_counts["network"]["affiliates"],

            "active_opportunities":
                pulse_counts["activity"]["active_opportunities"],
        },
        ...
        "opportunities": {
            ...
            "description":
                "Public-facing campaigns and side-hustle paths available through the PurPaws network.",
        ...
        "pulse_layers": [
            ...
            },
            {
                ...
                "reason":
                    "Available when active public campaigns exist.",
            },
            {
                "key":
                    "leaderboard_highlights",
                ...
                "reason":
                    "Historical Pulse leaderboard layer retained temporarily pending dedicated cleanup.",
            },
            {
                "key":
                    "featured_creators",
                ...
                "reason":
                    "Requires featured community curation.",
            },
            {
                "key":
                    "featured_rescues",
                ...
                "reason":
                    "Requires featured rescue curation.",
            },
            {
                "key":
                    "xrpl_verification",
                ...
                "reason":
                    "Future ledger verification pulse layer.",
            },
        ],
